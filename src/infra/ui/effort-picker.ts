...
const selectAnthropicEffort = (
  modelId: string,
  current: Maybe<AnthropicEffort>
): Future<Error, Maybe<AnthropicEffort>> => selectEffort<AnthropicEffort>(ANTHROPIC_EFFORTS, modelId, current, "high");
